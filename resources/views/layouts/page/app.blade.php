...
{{--                    </div>--}}
                ...
                <div class="col-auto mx-auto">
                    <a href="{{route('home_path')}}"><img src="{{asset('images/logo-destino.png')}}" width="200" alt="logo destino" class="img-fluid"></a>
                </div>
    ...
    <footer class="position-relative">
        ...
        <div class="d-block bg-dark">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <small class="small text-white">© 2020 proyecto destino</small>
                    </div>
